...
public class InterAppLoginResponse {
    private final String oisfJwtSSOEndpoint = "http://account.beta.doptor.gov.bd/jwtSSO";//"http://localhost:8082/jwtSSO";   //To Do. should read from database or properties file
